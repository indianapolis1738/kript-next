...
const Page = () => {
    ...
    return (
        <div className="p-4 max-w-7xl mx-auto">
            <div className="">
                <h1 className="justify-center items-center text-black font-poppins font-semibold text-[20px] md:text-[28px] lg:text-[60px] leading-[48px] md:leading-[100px]">
                    Market
                </h1>
            ...
            <div className="flex flex-col md:flex-row justify-between md:items-center mt-10 gap-4 p-2 md:gap-20">
                ...
                <table className="w-full table-auto border border-[#E4E7EC] rounded-2xl overflow-hidden text-start text-xs md:text-sm">
                    <thead className="bg-[#F9FAFB] text-[#475467] text-left">
                        <tr>
                            ...
                            <th className="px-2 py-3 md:px-6 md:py-4 font-medium">Change (24h)</th>
                            <th className="px-2 py-3 md:px-6 md:py-4 font-medium hidden md:table-cell">Action</th>
                        </tr>
                    </thead>
