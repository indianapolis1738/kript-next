  ...
  return (
    <div>
      ...
      >
        ...
        <motion.div
          className="max-w-7xl mx-auto mb-30"
        ...
        <div className="flex justify-center items-center flex-col md:flex-row mt-30 gap-10">
          ...
          >
            ...
            <p className="flex justify-center items-center mt-4 text-[16px] md:text-[20px]">
              Kript is a cutting-edge cryptocurrency trading platform that seamlessly combines innovation with accessibility. Whether you&apos;re a seasoned crypto enthusiast or a newcomer to the digital asset space, Kript offers a user-friendly experience for buying, selling, and holding a diverse range of cryptocurrencies.
            </p>
          </motion.div>
        </div>
