...
const Footer = () => {
  return (
    ...
    >
      <motion.div
        className="lg:flex block justify-between items-start w-full md:w-[90%] px-2 pt-[5%] pb-[2%] lg:w-[80%] mx-auto max-w-7xl"
      ...
      >
        {/* Left Section */}
        <motion.div
          className="lg:w-2/6 w-[90%] p-[5%] lg:p-0 flex flex-col gap-[2rem] items-start"
        ...
        {/* Middle Section */}
        <motion.div
          className="flex flex-row lg:gap-x-25 mt-8 md:mt-0"
          initial={{ opacity: 0, y: 50 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
          viewport={{ once: true }}
        ...
        {/* Right Section */}
        <motion.div
          className="flex flex-row mt-8 lg:ml-8 gap-10 md:mt-0"
          initial={{ opacity: 0, x: 50 }}
          whileInView={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.8 }}
          viewport={{ once: true }}
      ...
      >
        ...
        various products and services offered by Kript. While we strive to
        provide accurate and up-to-date details, this content should not be
        considered as financial advice, nor should it be solely relied upon for
        making financial or investment decisions. <br />
        <br />
        All our products and services can be accessed through the Kript App;
        however, availability is subject to regional restrictions, regulatory
        requirements, and operational limitations. Certain jurisdictions may
        impose legal constraints that affect access to specific features or
        services, and it is the responsibility of users to ensure they comply
        with the relevant laws and regulations in their country or region.{" "}
        <br />
        <br />
        We are committed to maintaining the reliability and accuracy of the
        information presented on our platform. However, we strongly encourage
        users to conduct their own independent research, evaluate their
        financial goals, and assess their level of expertise and risk tolerance
        before engaging in any cryptocurrency-related transactions. The crypto
        market is highly volatile, and users should be aware of the risks
        associated with trading or utilizing digital assets.
        <br />
        <br />
        Kript does not provide investment, tax, or financial advice, and we
        recommend consulting with a qualified professional before making any
